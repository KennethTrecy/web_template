...
## Origin
Some parts of the repository was based from [`comroconbu-vue`] branch of [Web Template].
...
[`comroconbu-vue`]: https://github.com/KennethTrecy/web_template/tree/comroconbu-vue
